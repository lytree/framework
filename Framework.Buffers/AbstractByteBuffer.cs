...
/// <summary>
///     Abstract base class implementation of a <see cref="T:Framework.Buffers.IByteBuffer" />
/// </summary>
public abstract partial class AbstractByteBuffer : IByteBuffer
{
    ...
    protected static readonly bool CheckAccessible = true; // accessed from CompositeByteBuf
    private static readonly bool CheckBounds  = true;

...
namespace Framework.OSS.SDK.HuaweiCloud.Internal
{
    internal class ObsParser : V2Parser
    {
        ...
        {
            return EnumAdaptor.ObsStorageClassEnumDict.ContainsKey(value) ? EnumAdaptor.ObsStorageClassEnumDict[value] : null;
        }

        protected override GroupGranteeEnum? ParseGroupGrantee(string value)
        {
            return EnumAdaptor.ObsGroupGranteeEnumDict.ContainsKey(value) ? EnumAdaptor.ObsGroupGranteeEnumDict[value] : null;
        }

        protected override EventTypeEnum? ParseEventTypeEnum(string value)
        {
            return EnumAdaptor.ObsEventTypeEnumDict.ContainsKey(value) ? EnumAdaptor.ObsEventTypeEnumDict[value] : null;
        }

...
namespace Framework.OSS.SDK.HuaweiCloud.Internal
{
    internal class V2Parser : IParser
    {
        ...
        {
            return EnumAdaptor.V2StorageClassEnumDict.ContainsKey(value) ? EnumAdaptor.V2StorageClassEnumDict[value] : null;
        }

        protected PermissionEnum? ParsePermission(string value)
        {
            return EnumAdaptor.PermissionEnumDict.ContainsKey(value) ? EnumAdaptor.PermissionEnumDict[value] : null;
        }

        protected virtual GroupGranteeEnum? ParseGroupGrantee(string value)
        {
            return EnumAdaptor.V2GroupGranteeEnumDict.ContainsKey(value) ? EnumAdaptor.V2GroupGranteeEnumDict[value] : null;
        }

        protected HttpVerb? ParseHttpVerb(string value)
        {
            return EnumAdaptor.HttpVerbEnumDict.ContainsKey(value) ? EnumAdaptor.HttpVerbEnumDict[value] : null;
        }

        protected RuleStatusEnum? ParseRuleStatus(string value)
        {
            return EnumAdaptor.RuleStatusEnumDict.ContainsKey(value) ? EnumAdaptor.RuleStatusEnumDict[value] : null;
        }

        protected VersionStatusEnum? ParseVersionStatusEnum(string value)
        {
            return EnumAdaptor.VersionStatusEnumDict.ContainsKey(value) ? EnumAdaptor.VersionStatusEnumDict[value] : null;
        }

        protected ProtocolEnum? ParseProtocol(string value)
        {
            return EnumAdaptor.ProtocolEnumDict.ContainsKey(value) ? EnumAdaptor.ProtocolEnumDict[value] : null;
        }

        protected FilterNameEnum? ParseFilterName(string value)
        {
            return EnumAdaptor.FilterNameEnumDict.ContainsKey(value) ? EnumAdaptor.FilterNameEnumDict[value] : null;
        }

        protected virtual EventTypeEnum? ParseEventTypeEnum(string value)
        {
            return EnumAdaptor.V2EventTypeEnumDict.ContainsKey(value) ? EnumAdaptor.V2EventTypeEnumDict[value] : null;
        }
